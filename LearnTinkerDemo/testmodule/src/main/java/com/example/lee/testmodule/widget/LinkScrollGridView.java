...
public class LinkScrollGridView extends HeaderGridView implements OnScrollListener {
    ...
    public LinkScrollGridView(Context context) {
        super(context);
        this.init(context);
    }

    public LinkScrollGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context);
    }

    public LinkScrollGridView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (pinSection == null || pinSection.getCount() == 0 || !mShouldPin || (firstVisibleItem < getHeaderViewCount())) {
            mCurrentHeader = null;
            mHeaderOffset = 0.0f;
        ...
        firstVisibleItem -= getHeaderViewCount();
    ...
    public void setmCurrentSection(int mCurrentSection) {
        this.mCurrentSection = mCurrentSection;
    }
